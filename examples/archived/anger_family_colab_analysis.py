...
!pip install git+https://github.com/raymondli-me/haam.git -q
...
try:
    ...
    print("✓ Created 3D UMAP visualization")
except Exception as e:
...
print(f"5. Human PoMA: {haam.results.get('human_poma', 0):.1%} of accuracy through measured cues")
print(f"6. AI PoMA: {haam.results.get('ai_poma', 0):.1%} of accuracy through measured cues")
