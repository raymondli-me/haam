...
# ==============================================================================
# GENERATE AND DISPLAY WORD CLOUDS FOR SPECIFIC PCs
# ==============================================================================

print("\n3. GENERATING AND DISPLAYING WORD CLOUDS FOR SPECIFIC PCs...")
print("-"*60)
...
# Generate word clouds for first few PCs and DISPLAY them
print("\nGenerating and displaying word clouds for first 5 PCs...")
successful_pcs = []
failed_pcs = []

# Display first 5 PCs individually
for i, pc_idx in enumerate(specific_pcs[:5]):
    print(f"\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(f"  Creating word cloud for PC{pc_idx + 1}...")
    print(f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    
    try:
        # Create word cloud with display=True to show in notebook
        fig, high_path, low_path = haam.create_pc_wordclouds(
            ...
            display=True  # THIS DISPLAYS IN NOTEBOOK!
        )
        
        print(f"    ✓ Saved - High pole: {high_path}")
        print(f"    ✓ Saved - Low pole: {low_path}")
...
# Generate remaining PCs without display (to save notebook space)
print("\n" + "="*60)
print("Generating remaining PCs (saving only, not displaying)...")
print("="*60)

for i, pc_idx in enumerate(specific_pcs[5:], start=5):
    ...
    try:
        fig, high_path, low_path = haam.create_pc_wordclouds(
            ...
            figsize=figsize,
            output_dir=wordcloud_dir,
            display=False  # Don't display these to save space
        )
...
print("\n" + "="*80)
print("4. CREATING AND DISPLAYING GRID VISUALIZATION...")
print("="*80)
...
try:
    grid_fig = haam.create_top_pcs_wordcloud_grid(
        ...
        display=True  # THIS DISPLAYS THE GRID IN NOTEBOOK!
    )
    print("✓ Grid visualization saved and displayed successfully!")
except Exception as e:
...
print("\n" + "="*80)
print("5. BATCH GENERATING ALL WORD CLOUDS...")
print("="*80)

# Generate all word clouds in batch mode (no display)
...
print("\n" + "="*80)
print("6. EXPLORING PC TOPICS FOR CONTEXT...")
print("="*80)
...
try:
    ...
    print("\nPC Topic Summary:")
    print("-"*60)
    for pc_idx in specific_pcs[:10]:  # Show first 10 for brevity
...
# ==============================================================================
# CREATE RANKING-BASED VISUALIZATIONS (OPTIONAL - SET display=True to show)
# ==============================================================================

print("\n" + "="*80)
print("7. CREATING RANKING-BASED VISUALIZATIONS...")
print("="*80)

# Create visualizations based on different ranking methods
...
for ranking in ranking_methods:
    ...
    try:
        ...
        fig = haam.create_top_pcs_wordcloud_grid(
            ...
            display=False  # Set to True if you want to see these too
        )
...
print("\n💡 TIP: To display more word clouds, change display=False to display=True")
print("   in the function calls above!")